...
class TDSSensorStub(SensorBase):
    ...
    def __init__(self):
        ...
        SensorBase.__init__(self, None, SensorType.TDS, "Total Dissolvable Solids (TDS) Sensor", 2, enabled, False)
...
class TDSSensor(SensorBase):
    ...
    def __init__(self):
        ...
        SensorBase.__init__(self, self.driver, SensorType.TDS, "Total Dissolvable Solids (TDS) Sensor", 2, enabled, False)
